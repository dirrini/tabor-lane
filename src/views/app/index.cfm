...
<cfif prc.isHtmxRequest><title>#encodeForHTML( prc.pageTitle )#</title></cfif>
    <section id="workspace-main" class="workspace-main" data-workspace-page="app" data-workspace data-board-id="#prc.workspaceBoard.found ? encodeForHTMLAttribute( prc.workspaceBoard.board.id ) : ''#" data-board-revision="#prc.workspaceBoard.found ? encodeForHTMLAttribute( prc.workspaceBoard.revision ) : ''#" data-board-revision-url="#prc.workspaceBoard.found ? '/app/boards/' & encodeForURL( prc.workspaceBoard.board.id ) & '/revision' : ''#" data-board-refresh-url="#prc.workspaceBoard.found ? '/app?boardId=' & encodeForURL( prc.workspaceBoard.board.id ) : '/app'#" data-csrf-token="#encodeForHTMLAttribute( prc.cardCsrfToken )#" data-move-success="#encodeForHTMLAttribute( $r( 'app.card.moved' ) )#" data-move-error="#encodeForHTMLAttribute( $r( 'app.card.moveError' ) )#" data-layout-saved="#encodeForHTMLAttribute( $r( 'app.lane.layoutSaved' ) )#" data-layout-error="#encodeForHTMLAttribute( $r( 'app.lane.layoutError' ) )#" data-viewed-now="#encodeForHTMLAttribute( $r( 'app.board.viewedNow' ) )#" data-viewed-minutes="#encodeForHTMLAttribute( $r( 'app.board.viewedMinutesAgo' ) )#" data-viewed-hours="#encodeForHTMLAttribute( $r( 'app.board.viewedHoursAgo' ) )#">
        ...
        <cfelse>
            <header class="workspace-header">
                ...
                <div class="board-toolbar-actions">
                    <span class="board-viewed-status" aria-live="polite"><i aria-hidden="true"></i><svg class="icon" aria-hidden="true"><use href="/resources/icons.svg##clock"></use></svg><span data-board-viewed-label>#$r( "app.board.viewedNow" )#</span></span>
